            ...
            if(VERTEX_RE.test(line)){
                ...
                for(var j = 0, eleLen = elements.length; j < eleLen; j++){
                    ...
                    if(elements[j] in unpacked.hashindices){
                         ...
                         */
                        // vertex position
                        unpacked.verts.push(parseFloat(verts[(vertex[0] - 1) * 3 + 0]));
                        unpacked.verts.push(parseFloat(verts[(vertex[0] - 1) * 3 + 1]));
                        unpacked.verts.push(parseFloat(verts[(vertex[0] - 1) * 3 + 2]));
                        // vertex textures
                        unpacked.textures.push(parseFloat(textures[(vertex[1] - 1) * 2 + 0]));
                        unpacked.textures.push(parseFloat(textures[(vertex[1] - 1) * 2 + 1]));
                        // vertex normals
                        unpacked.norms.push(parseFloat(vertNormals[(vertex[2] - 1) * 3 + 0]));
                        unpacked.norms.push(parseFloat(vertNormals[(vertex[2] - 1) * 3 + 1]));
                        unpacked.norms.push(parseFloat(vertNormals[(vertex[2] - 1) * 3 + 2]));
